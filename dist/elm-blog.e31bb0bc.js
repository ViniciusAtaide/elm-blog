...
var $author$project$Types$Token = function (a) {
	return {$: 'Token', a: a};
};
var $author$project$Types$Unknown = {$: 'Unknown'};
var $author$project$Types$GotUser = F2(
	function (a, b) {
		return {$: 'GotUser', a: a, b: b};
	});
...
var $author$project$Types$User = F3(
	function (id, name, following) {
		return {following: following, id: id, name: name};
	});
var $author$project$Types$FollowedUser = F2(
	function (a, b) {
		return {$: 'FollowedUser', a: a, b: b};
	});
var $author$project$Types$UserId = function (a) {
	return {$: 'UserId', a: a};
};
var $author$project$Api$userIdDecoder = A2($elm$json$Json$Decode$map, $author$project$Types$UserId, $elm$json$Json$Decode$int);
var $author$project$Api$followedUserDecoder = A2(
	$elm$json$Json$Decode$map,
	function (userId) {
		return A2($author$project$Types$FollowedUser, userId, $elm$core$Maybe$Nothing);
	},
	$author$project$Api$userIdDecoder);
var $author$project$Api$userDecoder = A4(
	$elm$json$Json$Decode$map3,
	$author$project$Types$User,
	A2($elm$json$Json$Decode$field, 'id', $author$project$Api$userIdDecoder),
	A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string),
	A2(
		$elm$json$Json$Decode$field,
		'following',
		$elm$json$Json$Decode$list($author$project$Api$followedUserDecoder)));
...
var $author$project$Api$fetchAuthenticatedUser = function (token) {
	if (token.$ === 'Just') {
		var fullToken = token.a;
		var tok = fullToken.a;
		return $lukewestby$elm_http_builder$HttpBuilder$request(
			A2(
				...
				A2(
					...
					$author$project$Types$GotUser(fullToken),
					$author$project$Api$userDecoder),
				A3(
					$lukewestby$elm_http_builder$HttpBuilder$withHeader,
					'X-Token',
					tok,
					$lukewestby$elm_http_builder$HttpBuilder$get('http://localhost:3000/api/me'))));
	} else {
...
var $author$project$Routing$Auth = {$: 'Auth'};
var $author$project$Routing$Signin = function (a) {
	return {$: 'Signin', a: a};
};
var $author$project$Routing$Signout = {$: 'Signout'};
...
var $author$project$Routing$routeParser = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			...
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Routing$Signout,
			$elm$url$Url$Parser$s('signout')),
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Routing$Auth,
			$elm$url$Url$Parser$s('auth'))
		]));
var $author$project$Routing$parseUrlToRoute = function (url) {
	return A2(
		$elm$core$Maybe$withDefault,
		$author$project$Routing$NotFound,
		A2($elm$url$Url$Parser$parse, $author$project$Routing$routeParser, url));
};
var $author$project$Main$sendTokenToStorage = _Platform_outgoingPort('sendTokenToStorage', $elm$json$Json$Encode$string);
...
var $author$project$Main$init = F3(
	function (flags, url, key) {
		var parsedUrl = $author$project$Routing$parseUrlToRoute(url);
		var token = function () {
			if (parsedUrl.$ === 'Signin') {
				var maybeGithubToken = parsedUrl.a;
				return A2($elm$core$Maybe$map, $author$project$Types$Token, maybeGithubToken);
			} else {
				return A2($elm$core$Maybe$map, $author$project$Types$Token, flags.storedToken);
			}
		}();
		var newModel = {
			auth: function () {
				if (token.$ === 'Nothing') {
					return $author$project$Types$LoggedOut;
				} else {
		...
		var commands = function () {
			if (token.$ === 'Just') {
				var fullToken = token;
				var tok = fullToken.a.a;
				return $elm$core$Platform$Cmd$batch(
					_List_fromArray(
						[
							$author$project$Main$sendTokenToStorage(tok),
							$author$project$Api$fetchAuthenticatedUser(fullToken)
						]));
			} else {
				return $elm$core$Platform$Cmd$none;
			}
...
var $author$project$Types$SendUserToExternalUrl = function (a) {
	return {$: 'SendUserToExternalUrl', a: a};
};
var $author$project$Types$SignUserIn = {$: 'SignUserIn'};
var $author$project$Types$SignUserOut = {$: 'SignUserOut'};
var $author$project$Main$onUrlRequest = function (urlRequest) {
	if (urlRequest.$ === 'External') {
		var externalUrl = urlRequest.a;
		return $author$project$Types$SendUserToExternalUrl(externalUrl);
	} else {
		var url = urlRequest.a;
		var _v1 = $author$project$Routing$parseUrlToRoute(url);
		switch (_v1.$) {
			case 'Signout':
				return $author$project$Types$SignUserOut;
			case 'Auth':
				return $author$project$Types$SignUserIn;
			default:
				return $author$project$Types$NoOp;
		}
	}
...
var $author$project$Types$Animate = function (a) {
	return {$: 'Animate', a: a};
};
...
var $author$project$Main$subscriptions = function (model) {
	return A2(
		...
		$author$project$Types$Animate,
		_List_fromArray(
			[model.style]));
};
var $author$project$Types$ClearErrorMsg = {$: 'ClearErrorMsg'};
var $author$project$Types$ErrorMsg = function (a) {
	return {$: 'ErrorMsg', a: a};
};
...
var $author$project$Main$clearTokenFromStorage = _Platform_outgoingPort(
	'clearTokenFromStorage',
	function ($) {
		return $elm$json$Json$Encode$null;
	});
var $author$project$Types$GotFollowed = function (a) {
	return {$: 'GotFollowed', a: a};
};
var $author$project$Api$fetchUser = F2(
	function (_v0, _v1) {
		var token = _v0.a;
		var userId = _v1.a;
		return $lukewestby$elm_http_builder$HttpBuilder$request(
			A2(
				$lukewestby$elm_http_builder$HttpBuilder$withExpect,
				A2($elm$http$Http$expectJson, $author$project$Types$GotFollowed, $author$project$Api$followedUserDecoder),
				A3(
					$lukewestby$elm_http_builder$HttpBuilder$withHeader,
					'X-Token',
					token,
					$lukewestby$elm_http_builder$HttpBuilder$get(
						'http://localhost:3000/api/users/' + $elm$core$String$fromInt(userId)))));
	});
var $author$project$Api$fetchFollowedUsersForUser = F2(
	function (token, user) {
		return $elm$core$Platform$Cmd$batch(
			A2(
				$elm$core$List$map,
				function (followedUser) {
					if (followedUser.b.$ === 'Nothing') {
						var userId = followedUser.a;
						var _v1 = followedUser.b;
						return A2($author$project$Api$fetchUser, token, userId);
					} else {
						return $elm$core$Platform$Cmd$none;
					}
				},
	...
	function (msg, model) {
		switch (msg.$) {
				...
				if (result.$ === 'Err') {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								auth: $author$project$Types$LoggedOut,
								errorMsg: $elm$core$Maybe$Just(
									$author$project$Types$ErrorMsg('Não Consegue Conectar ao Servidor'))
							}),
						$elm$core$Platform$Cmd$batch(
							_List_fromArray(
								[
									A2($elm$browser$Browser$Navigation$pushUrl, model.navigationKey, '/'),
									A2(
									$elm$core$Task$perform,
									function (_v2) {
										return $author$project$Types$ClearErrorMsg;
									},
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								auth: A2($author$project$Types$LoggedIn, token, user)
							}),
						A2($author$project$Api$fetchFollowedUsersForUser, token, user));
				}
			case 'GotFollowed':
				var result = msg.a;
				if (result.$ === 'Err') {
					...
					if (_v4.$ === 'LoggedIn') {
						...
						var newStatus = A2($author$project$Types$LoggedIn, token, newUser);
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{auth: newStatus}),
			...
			case 'SignUserIn':
				return _Utils_Tuple2(
					model,
					$elm$browser$Browser$Navigation$load('/auth'));
			case 'SignUserOut':
				return _Utils_Tuple2(
					_Utils_update(
						model,
					...
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								A2($elm$browser$Browser$Navigation$pushUrl, model.navigationKey, '/'),
								$author$project$Main$clearTokenFromStorage(_Utils_Tuple0)
							])));
			case 'SendUserToExternalUrl':
				var url = msg.a;
				return _Utils_Tuple2(
					model,
...
var $author$project$View$body = F2(
	function (style, error) {
		return A2(
			...
			A2(
				...
				$mdgriffith$elm_style_animation$Animation$render(style)),
			_List_fromArray(
				[
					function () {
					if (error.$ === 'Just') {
...
var $author$project$View$navOption = function (t) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
...
var $author$project$View$navOptions = A2(
	...
	_List_fromArray(
		[
			$author$project$View$navOption('Docs'),
			$author$project$View$navOption('Examples'),
			$author$project$View$navOption('Blog')
		]));
...
var $author$project$View$linkStyles = _List_fromArray(
	[
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Border$color(
				A3($mdgriffith$elm_ui$Element$rgb255, 155, 155, 155)),
				$mdgriffith$elm_ui$Element$Font$color(
				A3($mdgriffith$elm_ui$Element$rgb255, 255, 255, 255)),
				$mdgriffith$elm_ui$Element$Background$color(
				A3($mdgriffith$elm_ui$Element$rgb255, 59, 189, 176))
			])),
		$mdgriffith$elm_ui$Element$pointer
	]);
var $author$project$View$signInButton = A2(
	$mdgriffith$elm_ui$Element$link,
...
var $author$project$View$signOutButton = A2(
	$mdgriffith$elm_ui$Element$column,
	_List_Nil,
	_List_fromArray(
		[
...
var $author$project$View$nav = function (authStatus) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
		...
		A2(
			...
			_List_fromArray(
				[
					$author$project$View$navOptions,
					function () {
					if (authStatus.$ === 'LoggedIn') {
						return $author$project$View$signOutButton;
					} else {
						return $author$project$View$signInButton;
					}
				}()
				])));
};
...
var $author$project$View$title = A2(
	...
	$mdgriffith$elm_ui$Element$text('Elm Blog'));
var $author$project$View$header = function (authStatus) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$Background$color(
				A3($mdgriffith$elm_ui$Element$rgb255, 79, 209, 196)),
				$mdgriffith$elm_ui$Element$Font$color(
				A3($mdgriffith$elm_ui$Element$rgb255, 255, 255, 255)),
		...
		_List_fromArray(
			[
				...
				$author$project$View$nav(authStatus)
			]));
};
		...
		body: _List_fromArray(
			[
				...
				A2(
					...
					_List_fromArray(
						[
							$author$project$View$header(model.auth),
							A2($author$project$View$body, model.style, model.errorMsg)
						])))
			]),
		title: 'Elm Blog'
	};
		...
		A2(
			...
			$elm$json$Json$Decode$oneOf(
				_List_fromArray(
					...
					])))))({"versions":{"elm":"0.19.1"},"types":{"message":"Types.Msg","aliases":{"Animation.Msg":{"args":[],"type":"Animation.Model.Tick"},"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"},"Types.User":{"args":[],"type":"{ id : Types.UserId, name : String.String, following : List.List Types.FollowedUser }"}},"unions":{"Types.Msg":{"args":[],"tags":{"GotUser":["Types.Token","Result.Result Http.Error Types.User"],"GotFollowed":["Result.Result Http.Error Types.FollowedUser"],"SignUserIn":[],"SignUserOut":[],"NoOp":[],"SendUserToExternalUrl":["String.String"],"PushUrl":["Url.Url"],"Toast":[],"ClearErrorMsg":[],"Animate":["Animation.Msg"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Types.FollowedUser":{"args":[],"tags":{"FollowedUser":["Types.UserId","Maybe.Maybe Types.User"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"Animation.Model.Tick":{"args":[],"tags":{"Tick":["Time.Posix"]}},"Types.Token":{"args":[],"tags":{"Token":["String.String"]}},"Types.UserId":{"args":[],"tags":{"UserId":["Basics.Int"]}},"Time.Posix":{"args":[],"tags":{"Posix":["Basics.Int"]}}}}})}});
...
app.ports.clearTokenFromStorage.subscribe(function () {
...
//# sourceMappingURL=/elm-blog.e31bb0bc.js.map