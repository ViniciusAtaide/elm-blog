	...
	function (_v0, url, key) {
		...
		var token = function () {
			if (parsedUrl.$ === 'Signin') {
				...
				return $elm$core$Maybe$Just(
					$author$project$Types$Token('token'));
			}
		}();
		var newModel = {
			auth: function () {
...
var $author$project$Main$clearErrorMsg = $elm$core$Platform$Cmd$none;
						...
						$elm$core$Platform$Cmd$batch(
							_List_fromArray(
								[
									...
									$author$project$Main$clearErrorMsg
								])));
				} else {
					var user = result.a;
					return _Utils_Tuple2(
